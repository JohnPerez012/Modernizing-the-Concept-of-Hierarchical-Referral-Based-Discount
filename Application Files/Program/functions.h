...
/////////////////////////////////////////////////////////////////
/**
 *  To check the data present or not
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 *  Menu of the program after Log-in
 */
/////////////////////////////////////////////////////////////////
void menu()
{
...
/////////////////////////////////////////////////////////////////
/**
 *  Clear buffer to make the input clean with no unintended characters
 */
/////////////////////////////////////////////////////////////////
void clearBuffer()
{
...
/////////////////////////////////////////////////////////////////
/**
 *  Funtion returns 1's or 0's if the referral is valid; something
 *  the inputted referral is in use of another account/present in
 *  Data Base
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * Check the referal usage if the user is valid for linking another account
 * Limit only 2 usage
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * The program will prompt the referral suggestions if the user
 * input the referral that reach the limit of usage
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * If the user has the referral of -1 then let then link their account
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * The function returns boolean if the id that pass as an argument
 * is unique
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * After the user create new account then the program automatically
 * generate unique referrals
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * This function implements the rule of the discounts
 */
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
/**
 * Increment the usage of the passed argument if the referral
 * has used by another account
 */
/////////////////////////////////////////////////////////////////
